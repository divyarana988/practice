...
public class StudentServiceImpl implements StudentService{
    ...
    public Student saveStudent(Student student) {
        // redisTemplate.opsForValue().set( "Student: " +
        // student.getStudent_id().toString(), student);
    ...
    public List<Student> getStudentList() {
        ...
        for (int i = 0; i < studentListFromDb.size(); i++) {
            ...
            redisTemplate.opsForValue().set("Student: " + accessEachStudentFromList.getId().toString(),
                    accessEachStudentFromList);
        }
